...
class YtDlpAdapter(BaseDecoder):
    ...
    def parse(cls, url: str, **kwargs) -> List[MetaVideo]:
        warnings.warn("This experimental decoder based on `yt_dlp` project and not support asyncio", stacklevel=2)
        try:
            with YoutubeDL() as ydl:
                ...
                for metadata in info["formats"]:
                    ...
                    objects.append(MetaVideo(type=metadata['video_ext'], url=metadata['url'],
