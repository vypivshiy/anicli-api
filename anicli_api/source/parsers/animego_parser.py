...
class OngoingView(__BaseViewModel):
    ...
    @staticmethod
    def _parse_episode(part: Selector) -> str:
        # script signature:
        # css ".text-truncate"
        # text
        # re "(\d+)\s"
...
class AnimeView(__BaseViewModel):
    ...
    @staticmethod
    def _parse_raw_json(part: Selector) -> str:
        # script signature:
...
class EpisodeView(__BaseViewModel):
    ...
    @staticmethod
    def _parse_num(part: Selector) -> str:
        # script signature:
        # attr "data-episode"
        #
...
class SourceView(__BaseViewModel):
    ...
    @staticmethod
    def _parse_data_provider(part: Selector) -> str:
        # script signature:
        # attr "data-provider"
        #
    ...
    @staticmethod
    def _parse_data_provide_dubbing(part: Selector) -> str:
        # script signature:
