...
class PageOngoing:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect(".all_anime_global")
        return v0

    def _parse_url(self, v: html.HtmlElement) -> str:
        v0 = v.cssselect("a")[0]
        v1 = v0.get("href")
        v2 = f"https://jut.su{v1}"
        return v2
...
class PageAnime:
    ...
    def _parse_title(self, v: html.HtmlElement) -> str:
        ...
        v1 = v0.text_content()
        v2 = re.search("Смотреть\\s*(.*?)\\s*все", v1)[1]
        return v2
...
class SourceView:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect("#my-player > source")
        return v0
