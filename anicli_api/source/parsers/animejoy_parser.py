...
NOTE: this source have CLOUDFLARE, sometimes maybe not works AND add delay per request
...
class OngoingView(__BaseViewModel):
    ...
    @staticmethod
    def _parse_alt_title(part: Selector) -> str:
        # script signature:
        # css ".romanji"
        # text
        #
...
class AnimeView(__BaseViewModel):
    ...
    @staticmethod
    def _parse_news_id(part: Selector) -> str:
        # script signature:
