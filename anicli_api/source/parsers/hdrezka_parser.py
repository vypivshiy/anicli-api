...
class HdrezkaCdnSeriesAPI:
    @classmethod
    def get_stream(
        cls, client: httpx.Client, *, timestamp: int, id: str, translator_id: str, season: str, episode: str, favs: str
    ) -> GetStreamResult:
        return cast(
            GetStreamResult,
            ssc_rest_call(
    ...
    @classmethod
    def get_movie(
        cls, client: httpx.Client, *, timestamp: int, id: str, translator_id: str, favs: str
    ) -> GetMovieResult:
        return cast(
            GetMovieResult,
            ssc_rest_call(
                ...
                params={"t": timestamp},
                data={"id": id, "translator_id": translator_id, "favs": favs, "action": "get_movie"},
            ),
        )

    @classmethod
    async def async_get_movie(
        cls, client: httpx.AsyncClient, *, timestamp: int, id: str, translator_id: str, favs: str
    ) -> GetMovieResult:
        return cast(
            GetMovieResult,
            await ssc_rest_call_async(
