...
class SeasonBox:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect(".serial-panel > .serial-seasons-box option")
        return v0
...
class SeriesBox:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect(".serial-panel > .serial-series-box option")
        return v0
...
class SeriesOptions:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect(".serial-panel > .series-options div")
        return v0
...
class TranslationsBox:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect(".serial-panel > .serial-translations-box option")
        return v0
...
class MovieTranslationBox:
    ...
    def _split_doc(self, v: html.HtmlElement) -> list[html.HtmlElement]:
        v0 = v.cssselect(".movie-panel > .movie-translations-box option")
        return v0
...
class PageMainKodikVideo:
    ...
    def _parse_translation_box(self, v: html.HtmlElement) -> list[T_MovieTranslationBox]:
        v0 = MovieTranslationBox(v).parse()
        return v0
